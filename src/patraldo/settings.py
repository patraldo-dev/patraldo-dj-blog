"""
Django settings for patraldo project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '.src-broken-dew-5673.fly.dev', 'patraldo.dev'] 
...
WSGI_APPLICATION = 'patraldo.wsgi.application'
